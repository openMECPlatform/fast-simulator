...
class Last(object):
    ...
    def execute(self):
        ...
        if not total_cost:
            print "Last - Try to determine number of failed migration"
    ...
    def _find_ten(self, vtan):
        ...
        if visited_edge_dict:
            ...
            # print "Selected path list:", [path_dict[node] for node, cost in trial_dict.items() if cost == trial_dict[final_target]]
                # path_dict[final_target]
