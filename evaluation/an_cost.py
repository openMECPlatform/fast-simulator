...
path = "/home/test/00-fast-journal/moop/fast-integration/fast-simulation/evaluation/results/sample/"
...
ax1.set_xlabel(r'Number of access nodes', fontsize=16, fontname='Times New Roman')
ax1.set_ylabel('Total cost', fontsize=16, fontname='Times New Roman')
...
ax1.legend(ncol=2, labelspacing=0.05, prop={'size': 14,'family':'Times New Roman'}, loc='lower right')

# ax1.legend(bbox_to_anchor=(0., 1.02, 1., .102), ncol=6, borderaxespad=0., prop={'size': 15, 'family': 'Times New Roman'}, loc='lower left')

plt.savefig("/home/test/00-fast-journal/moop/fast-integration/fast-simulation/evaluation/results/sample/total_cost.pdf")
...
ax2.set_xlabel(r'Number of access nodes', fontsize=16, fontname='Times New Roman')
ax2.set_ylabel('Communication cost (Mbps)', fontsize=16, fontname='Times New Roman')
...
ax2.legend(ncol=2, labelspacing=0.05, prop={'size': 14,'family':'Times New Roman'}, loc='lower right')


plt.savefig("/home/test/00-fast-journal/moop/fast-integration/fast-simulation/evaluation/results/sample/comm_cost.pdf")
#
# # ======================================================================================
#
#
...
# plt.title(r'$\alpha_{max} = 3$', fontsize=16, fontname='Times New Roman')
ax3.set_xlabel(r'Number of access nodes', fontsize=18, fontname='Times New Roman')
...
ax3.legend(ncol=2, labelspacing=0.05, prop={'size': 14,'family':'Times New Roman'}, loc='center')


# ax3.legend(prop={'size': 12,'family':'Times New Roman'})

plt.savefig("/home/test/00-fast-journal/moop/fast-integration/fast-simulation/evaluation/results/sample/buff_cost.pdf")
...
# plt.title(r'$\alpha_{max} = 3$', fontsize=16, fontname='Times New Roman')
ax4.set_xlabel(r'Number of access nodes', fontsize=18, fontname='Times New Roman')
...
ax4.legend(prop={'size': 14,'family':'Times New Roman'}, loc='upper left')

plt.savefig("/home/test/00-fast-journal/moop/fast-integration/fast-simulation/evaluation/results/sample/mig_time.pdf")
...
# flierprops = dict(marker='o', markerfacecolor='green', markersize=12,linestyle='none')
# medianprops = dict(linestyle='-.', linewidth=1.5, color='firebrick')
plt.errorbar(index, opt_exec_time_result, yerr=opt_exec_time_err, color=colors[0], linewidth=3, marker='.', label=r'Optimal', capsize=3, fillstyle='none')
plt.errorbar(index, past_exec_time_result, yerr=past_exec_time_err, color=colors[5], linewidth=3, marker='x', markersize=15, label=r'Tabu', markeredgewidth=2, capsize=3, fillstyle='none')
plt.errorbar(index, rast_exec_time_result, yerr=rast_exec_time_err, color=colors[4], linewidth=3, marker='^', markersize=8, label=r'Random', capsize=3, fillstyle='none')
plt.errorbar(index, last_exec_time_result, yerr=last_exec_time_err, color=colors[3], linewidth=3, marker='o', markersize=8, label=r'LAST', capsize=3)
plt.errorbar(index, bast_exec_time_result, yerr=bast_exec_time_err, color=colors[1], linewidth=3, marker='s', markersize=10, label=r'CAST', capsize=3, fillstyle='none')
plt.errorbar(index, base_exec_time_result, yerr=base_exec_time_err, color=colors[2], linewidth=3, linestyle='--', marker='.', markersize=5, label=r'No migration', capsize=3, fillstyle='none')
...
# plt.title(r'$\alpha_{max} = 3$', fontsize=16, fontname='Times New Roman')
ax5.set_xlabel(r'Number of access nodes', fontsize=16, fontname='Times New Roman')
ax5.set_ylabel('Execution time (s)', fontsize=16, fontname='Times New Roman')

ax5.legend(prop={'size': 12,'family':'Times New Roman'})

plt.savefig("/home/test/00-fast-journal/moop/fast-integration/fast-simulation/evaluation/results/sample/exec_time.pdf")
...
# plt.title(r'$\alpha_{max} = 3$', fontsize=16, fontname='Times New Roman')
ax6.set_xlabel(r'Number of access nodes', fontsize=16, fontname='Times New Roman')
ax6.set_ylabel('Compuration cost', fontsize=16, fontname='Times New Roman')

#ax6.legend(prop={'size': 12,'family':'Times New Roman'})

ax6.legend(prop={'size': 12,'family':'Times New Roman'})

plt.savefig("/home/test/00-fast-journal/moop/fast-integration/fast-simulation/evaluation/results/sample/comp_cost.pdf")
